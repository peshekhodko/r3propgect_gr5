...
as vary true variances, sample sizes and true means differences. We will get empirical power by simulation as a function of different 
...
Under each combination we will generate sample under $H_A$ N time. Then we will perform t.tests for equal and unequal variances and 
calculate number of time $H_0$ is regected. Empirical power for both tests will be calculated and analyzed.

Since we need to simulate data as a function of different combination of several parameters and make some manipulations with this data, 
function for power calculations is created.
