...
Since we need to simulate data as a function of different combinations of several parameters and make some manipulations with this data, a function for power calculation is created. This function takes a parameter sample sizes $n_1$ and $n_2$.  During our simulation we used to create data for different combinations. 
...
# Plot power as a function of mu differences
